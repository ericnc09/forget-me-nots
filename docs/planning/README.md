...
These documents preserve the FollowThrough product planning prepared before the event. They describe intended behavior and product hypotheses, not the current implementation of Forget-me-nots.

- [Standalone build prompt](followthrough-build-prompt.md): draft-only Outlook workflow, persistent task store, owner controls, and evaluation requirements.
